...
4);a=new g.W({F:"button",Aa:["ytp-miniplayer-close-button","ytp-button"],T:{"aria-label":"Close"},R:[g.sG()]});g.J(this,a);a.ra(this.mC.element);this.N(a.element,"click",this.Nj);a=new g.W({F:"button",Aa:["ytp-miniplayer-replay-button","ytp-button"],T:{"aria-label":"Close"},R:[g.yG()]});g.J(this,a);a.ra(this.mC.element);this.N(a.element,"click",this.XZ);this.N(this.player,"presentingplayerstatechange",this.Tc);this.N(this.player,"appresize",this.ub);this.N(this.player,"fullscreentoggled",this.ub);
this.ub()};
